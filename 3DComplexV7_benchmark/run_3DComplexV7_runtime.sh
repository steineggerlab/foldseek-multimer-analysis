...
while read line || [ -n "$line" ] ; do
    ...
    /usr/bin/time $2 easy-complexsearch $query $DIR/tmp/3DComplexV7_clusearchdb ./tmp/3DComplexV7_aln ./tmp/tmp --cluster-search 1 --threads 1 2>> $DIR/tmp/fs_time.log
    /usr/bin/time $2 easy-complexsearch $query $DIR/tmp/3DComplexV7_clusearchdb ./tmp/3DComplexV7_aln ./tmp/tmp --cluster-search 1 --threads 1 --alignment-type 1 2>> $DIR/tmp/ft_time.log
